...
// let order = orders.find(order => order.id === 11070);
...
// let order = orders.find(order => order.shipAddress.country === "Germany");
...
// let order = orders.find(order => order.id === 11065);

// if (order) {
//   console.log(`shipname: ${order.shipName}\ncountry: ${order.shipAddress.country}\ncity: ${order.shipAddress.city}`);
// } else {
//   console.log("Not Found");
// }


// 4.ID-i 10550 olan obyektin neçə növdə satış edildiyini tapın və consoledə yazdırın. 
// let order = orders.find(order => order.id === 10550);

// if(order) {
//     let sell = order.details.length;
//     console.log(`ID-i 10550 olan obyektin ${sell} növdə satısi var`);
// }
// else {
//     console.log("Not Found");
...
// let order = orders.find(order => order.id === 10310);

// if(order){
//     let sum = details.productId + details.unitPrice + details.discount + details.quantity
//     console.log(`toplam qazancını:${sum}`);
